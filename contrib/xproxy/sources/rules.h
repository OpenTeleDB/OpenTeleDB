...
struct od_rule {
	...
	int allow_clear_text_frontend_auth;
	char *auth_query;
	char *auth_query_db;
	...
	int password_len;
	/* storage */
	/* storage in od_rule is a copy of storage in od_rules, not a reference */
	...
	int catchup_timeout;
	int catchup_checks;
	int64_t replication_delay_threshold;
	...
	double *quantiles;
	int quantiles_count;
	int enable_quantiles_stat;
	uint64_t server_lifetime_us;
	int enable_read_only_blacklist;
...
bool od_storage_endpoints_compare_same(const od_storage_endpoint_t *a, const od_storage_endpoint_t *b);
bool od_storage_endpoints_same_host_and_port(const od_storage_endpoint_t *a, const od_storage_endpoint_t *b);
