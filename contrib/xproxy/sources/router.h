...
int od_router_expire(od_router_t *, od_list_t *, od_list_t *);
...
od_router_status_t od_router_attach_new(od_client_t *, char *);
od_router_status_t od_router_attach(od_router_t *, od_client_t *, od_replica_role_t, bool);
od_router_status_t od_router_attach_to_pool(od_router_t *, od_client_t *, size_t);
...
static inline od_replica_role_t od_get_replica_role(od_server_t *server) {
	od_route_t *route =  server->route;
	return route->server_pool[server->endpoint_selector].replica_role;
}
