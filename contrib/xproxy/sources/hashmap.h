...
struct od_hashmap {
	size_t size;
	od_atomic_u32_t items;
	bool concurrent;
	// ISO C99 flexible array member
	od_hashmap_bucket_t **buckets;
};

extern od_hashmap_t *od_hashmap_create(size_t sz, bool concurrent);
...
od_retcode_t od_hashmap_empty_except(od_hashmap_t *hm, od_hashmap_elt_t *);
