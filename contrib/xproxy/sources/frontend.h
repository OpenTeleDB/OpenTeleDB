...
extern od_frontend_status_t cron_close_expired_prep_stmt(od_server_t *server);
extern od_frontend_status_t od_frontend_deallocate_check(char *err_data, int size, od_client_t *client);
