...
GRANT CREATE ON DATABASE contrib_regression TO regress_role_admin WITH GRANT OPTION;
...
GRANT CREATE ON DATABASE contrib_regression TO regress_createrole WITH GRANT OPTION;
...
GRANT CREATE ON DATABASE contrib_regression TO regress_tenant2;
...
REVOKE CREATE ON DATABASE contrib_regression FROM regress_createrole CASCADE;
...
REVOKE CREATE ON DATABASE contrib_regression FROM regress_role_admin CASCADE;
DROP INDEX tenant_idx;
DROP TABLE tenant_table;
DROP VIEW tenant_view;
