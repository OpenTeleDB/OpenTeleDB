...
\dA contrib_regression.heap
\dA nonesuch.heap
\dt host.contrib_regression.pg_catalog.pg_class
\dt |.pg_catalog.pg_class
\dt nonesuch.pg_catalog.pg_class
\da host.contrib_regression.pg_catalog.sum
\da +.pg_catalog.sum
\da nonesuch.pg_catalog.sum
\dAc nonesuch.brin
\dAc contrib_regression.brin
\dAf nonesuch.brin
\dAf contrib_regression.brin
\dAo nonesuch.brin
\dAo contrib_regression.brin
\dAp nonesuch.brin
\dAp contrib_regression.brin
\db nonesuch.pg_default
\db contrib_regression.pg_default
\dc host.contrib_regression.public.conversion
\dc (.public.conversion
\dc nonesuch.public.conversion
\dC host.contrib_regression.pg_catalog.int8
\dC ).pg_catalog.int8
\dC nonesuch.pg_catalog.int8
\dd host.contrib_regression.pg_catalog.pg_class
\dd [.pg_catalog.pg_class
\dd nonesuch.pg_catalog.pg_class
\dD host.contrib_regression.public.gtestdomain1
\dD ].public.gtestdomain1
\dD nonesuch.public.gtestdomain1
\ddp host.contrib_regression.pg_catalog.pg_class
\ddp {.pg_catalog.pg_class
\ddp nonesuch.pg_catalog.pg_class
\dE host.contrib_regression.public.ft
\dE }.public.ft
\dE nonesuch.public.ft
\di host.contrib_regression.public.tenk1_hundred
\di ..public.tenk1_hundred
\di nonesuch.public.tenk1_hundred
\dm host.contrib_regression.public.mvtest_bb
\dm ^.public.mvtest_bb
\dm nonesuch.public.mvtest_bb
\ds host.contrib_regression.public.check_seq
\ds contrib_regression|mydb.public.check_seq
\ds nonesuch.public.check_seq
\dt host.contrib_regression.public.b_star
\dt regres+ion.public.b_star
\dt nonesuch.public.b_star
\dv host.contrib_regression.public.shoe
\dv regress(ion).public.shoe
\dv nonesuch.public.shoe
\des nonesuch.server
\des contrib_regression.server
\des nonesuch.server
\des contrib_regression.server
\des nonesuch.username
\des contrib_regression.username
\dew nonesuch.fdw
\dew contrib_regression.fdw
\df host.contrib_regression.public.namelen
\df regres[qrstuv]ion.public.namelen
\df nonesuch.public.namelen
\dF host.contrib_regression.pg_catalog.arabic
\dF regres{1,2}ion.pg_catalog.arabic
\dF nonesuch.pg_catalog.arabic
\dFd host.contrib_regression.pg_catalog.arabic_stem
\dFd regres?ion.pg_catalog.arabic_stem
\dFd nonesuch.pg_catalog.arabic_stem
\dFp host.contrib_regression.pg_catalog.default
\dFp ^contrib_regression.pg_catalog.default
\dFp nonesuch.pg_catalog.default
\dFt host.contrib_regression.pg_catalog.ispell
\dFt contrib_regression$.pg_catalog.ispell
\dFt nonesuch.pg_catalog.ispell
\dg nonesuch.pg_database_owner
\dg contrib_regression.pg_database_owner
\dL host.contrib_regression.plpgsql
\dL *.plpgsql
\dL nonesuch.plpgsql
\dn host.contrib_regression.public
\dn """".public
\dn nonesuch.public
\do host.contrib_regression.public.!=-
\do "contrib_regression|mydb".public.!=-
\do nonesuch.public.!=-
\dO host.contrib_regression.pg_catalog.POSIX
\dO .pg_catalog.POSIX
\dO nonesuch.pg_catalog.POSIX
\dp host.contrib_regression.public.a_star
\dp "regres+ion".public.a_star
\dp nonesuch.public.a_star
\dP host.contrib_regression.public.mlparted
\dP "regres(sion)".public.mlparted
\dP nonesuch.public.mlparted
\drds nonesuch.lc_messages
\drds contrib_regression.lc_messages
\dRp public.mypub
\dRp contrib_regression.mypub
\dRs public.mysub
\dRs contrib_regression.mysub
\dT host.contrib_regression.public.widget
\dT "contrib_regression{1,2}".public.widget
\dT nonesuch.public.widget
\dx contrib_regression.plpgsql
\dx nonesuch.plpgsql
\dX host.contrib_regression.public.func_deps_stat
\dX "^contrib_regression$".public.func_deps_stat
\dX nonesuch.public.func_deps_stat
\dy contrib_regression.myevt
\dy nonesuch.myevt
...
\dt contrib_regression."no.such.schema"."no.such.table.relation"
\da contrib_regression."no.such.schema"."no.such.aggregate.function"
\dc contrib_regression."no.such.schema"."no.such.conversion"
\dC contrib_regression."no.such.schema"."no.such.cast"
\dd contrib_regression."no.such.schema"."no.such.object.description"
\dD contrib_regression."no.such.schema"."no.such.domain"
\di contrib_regression."no.such.schema"."no.such.index.relation"
\dm contrib_regression."no.such.schema"."no.such.materialized.view"
\ds contrib_regression."no.such.schema"."no.such.relation"
\dt contrib_regression."no.such.schema"."no.such.relation"
\dv contrib_regression."no.such.schema"."no.such.relation"
\df contrib_regression."no.such.schema"."no.such.function"
\dF contrib_regression."no.such.schema"."no.such.text.search.configuration"
\dFd contrib_regression."no.such.schema"."no.such.text.search.dictionary"
\dFp contrib_regression."no.such.schema"."no.such.text.search.parser"
\dFt contrib_regression."no.such.schema"."no.such.text.search.template"
\do contrib_regression."no.such.schema"."no.such.operator"
\dO contrib_regression."no.such.schema"."no.such.collation"
\dp contrib_regression."no.such.schema"."no.such.access.privilege"
\dP contrib_regression."no.such.schema"."no.such.partitioned.relation"
\dT contrib_regression."no.such.schema"."no.such.data.type"
\dX contrib_regression."no.such.schema"."no.such.extended.statistics"
