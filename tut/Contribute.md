...
为了更好保护OpenTeleDB项目和社区用户，我们采用默认签署机制：只要您向本项目提交贡献，即视为同意本贡献者许可协议（CLA）条款。
### 1、知识产权归属
贡献者声明并保证，其拥有或有权授予被许可方非独占、全球性、永久性、免版税、不可撤销的专利许可，以使用、制造、销售、许诺销售、进口或以其他方式处置被许可方根据本协议获得的贡献，但该许可不涵盖因被许可方对贡献的修改而必然侵犯的专利权利（以下简称‘必然侵权专利’）。
### 2、专利许可
贡献者进一步声明，其拥有或有权授予被许可方使用与贡献相关的所有专利权利（包括已申请或未申请的专利）。若贡献涉及第三方专利，贡献者需确保已获得合法授权，并承担因专利侵权（包括必然侵权专利）导致的全部责任。被许可方对必然侵权专利不承担任何许可或侵权责任。
### 3、商标使用
贡献者不得以任何方式使用项目方的商标、标识或品牌名称，除非获得项目方的书面授权。贡献者提交的文档或代码中如需引用项目名称，需遵循项目方的品牌使用指南。
### 4、著作权声明
贡献者保留对贡献的著作权，但同意被许可方在遵守项目许可证的前提下，自由使用、修改和分发贡献。贡献者需在提交时声明其遵守的许可证类型。
### 5、侵权责任与免责
贡献者保证其贡献不侵犯任何第三方的知识产权，并承担因侵权导致的全部法律费用、赔偿金及损失。若发生侵权纠纷，贡献者需立即通知项目方并协助解决。项目方对贡献者的侵权行为不承担任何连带责任。
### 6、 保密义务
贡献者在参与项目期间及之后，不得泄露或使用项目方的未公开信息（如源代码、设计文档、商业计划等），除非获得项目方书面授权或信息已公开。
### 7、争议解决
因本协议引起的或与本协议有关的任何争议，双方应首先通过友好协商解决。协商不成时，任何一方可向项目方所在地有管辖权的人民法院提起诉讼。
